...
** Last update Mon Jan 25 21:51:50 2016 charles-elie taupin
*/
			       ...
			       void *_void)
{
  ...
  if (key == BKS_ESCAPE)
  ...
  else if (key == BKS_A && state == GO_DOWN && pass->edit.scale > 1)
    pass->edit.scale--;
  else if (key == BKS_E && state == GO_DOWN && pass->edit.scale < 50)
    pass->edit.scale++;
    ...
    pass->edit.menu.cur++;
  else if (key == BKS_D && state == GO_DOWN && pass->edit.pal.cur < 15)
    pass->edit.pal.cur++;
  else if (key == BKS_Q && state == GO_DOWN && pass->edit.pal.cur > 0)
    pass->edit.pal.cur--;
...
void		init(t_base *pass)
{
  ...
  pass->edit.pal.but = 15;
  pass->edit.pal.cur = 0;
  pass->edit.pal.col = 0xFF888888;
  pass->edit.pal.scol = 0xFFAAAAAA;
  pass->edit.pal.bcol[0] = YELLOW;
  pass->edit.pal.bscol[0] = WHITE;
  pass->edit.pal.bcol[1] = 0xFF00B7FF;
  pass->edit.pal.bcol[2] = RED;
  pass->edit.pal.bcol[3] = 0xFF002958;
  pass->edit.pal.bcol[4] = DF_COL;
  pass->edit.pal.bcol[5] = PURPLE;
  pass->edit.pal.bcol[6] = TEAL;
  pass->edit.pal.bcol[7] = 0xFFFFB300;
  pass->edit.pal.bcol[8] = BLUE;
  pass->edit.pal.bcol[9] = GREEN;
  pass->edit.pal.bcol[10] = 0xFF00A316;
  pass->edit.pal.bcol[11] = 0xFF004A0A;
  pass->edit.pal.bcol[12] = WHITE;
  pass->edit.pal.bcol[13] = 0xFF777777;
  pass->edit.pal.bcol[14] = BLACK;
  pass->edit.col = RED;
  pass->edit.center.x = WIN_WH;
  pass->edit.center.y = WIN_HH;
  pass->mpos.x = 0;
...
int			main(int ac, char **av)
{
  ...
  (ac == 3) ? (tekfill(pass->edit.map, BLUE)) : (void)pass->edit.scale;
    if ((pass->win = bunny_start(WIN_W, WIN_H, 0, "LibLapin")) == NULL)
    return (0);
