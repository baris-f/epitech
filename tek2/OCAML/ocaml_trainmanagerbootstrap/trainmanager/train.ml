...
module CitiesInfo : CITIESINFO =
  struct
    let dist = [("Brest", "Rennes", 248) ; ("Rennes", "Le Mans", 163) ; ("Le Mans", "Nantes", 183) ; ("Le Mans", "Paris", 201) ; ("Paris", "Bordeaux", 568) ; ("Lille", "Brussels", 106) ; ("Lille", "London", 269) ; ("Paris", "Lille", 225) ; ("Brussels", "Liege", 104) ; ("Paris", "Le Havre", 230) ; ("Liege", "Cologne", 118) ; ("Cologne", "Essen", 81) ; ("Paris", "Nancy", 327) ; ("Dijon", "Nancy", 226) ; ("Nancy", "Strasbourg", 149) ; ("Paris", "Strasbourg", 449) ; ("Brussels", "Amsterdam", 211) ; ("Dijon", "Strasbourg", 309)]
